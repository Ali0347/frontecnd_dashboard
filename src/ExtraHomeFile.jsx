                ...
                <div className="card-tools">
                  <ul className="nav nav-pills ml-auto">
                    <li className="nav-item">
                      <Link className="nav-link active" to={"#revenue-chart"} data-toggle="tab">Area</Link> 
                    </li>
                    <li className="nav-item">
                      <Link className="nav-link" to={"#sales-chart" }data-toggle="tab">Donut</Link> 
                    </li>
                  </ul>
                </div>
              </div>{/* /.card-header */}
                ...
                <div className="card-tools">
                  ...
                  <div className="btn-group">
                    ...
                    <div className="dropdown-menu" role="menu">
                      <Link to={"#"} className="dropdown-item">Add new event</Link> 
                      <Link to={"#"} className="dropdown-item">Clear events</Link> 
                      <div className="dropdown-divider" />
                      <Link to={"#"} className="dropdown-item">View calendar</Link> 
                    </div>
                  </div>
